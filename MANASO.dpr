...
uses
  ...
  ASO260L in 'ASO260L.pas' {FAutDec},
  ASO205B in 'ASO205B.pas' {FViewPDF},
  CRE989 in 'CRE989.pas' {fContactabilidadVerificada},
  ASO269 in 'ASO269.pas' {FHistConDatos},
  ASO260O in 'ASO260O.pas' {FManCodigoPago},
  ASO964 in 'ASO964.pas' {Fautdes},
  ASO969 in 'ASO969.pas' {FConfirmaDesautDcto},
  ASO958C in 'ASO958C.pas' {FConfirma},
  ASO260R in 'ASO260R.pas' {FMenCarnetExt},
  ASO260P in 'ASO260P.pas' {Fcarneextranjeria};
