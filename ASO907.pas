...
// Actualizaciones:
// HPC_201801_MAS
// ASO_201901_HPC          : Se corrige problema de asignación de colegio
...
//Se corrige problema de asignación de colegio
   xSql := 'SELECT '' '' NIVMOD, '' '' CODMOD, '' '' NOMCENEDU, '' '' DIREC, '' '' TELEFONO, '' '' CENPO, '' '' DPTODES, '' '' CIUDDES, '' '' ZIPDES, '
           +'       '' '' UBIGEO_DIR, '' '' CENEDUID '
           +'FROM DUAL ';
   DM1.cdsCEdu.Close;
