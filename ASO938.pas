...
// Actualizaciones:
// HPC_201801_MAS
// MAS_201902_HPC        : Se valida que no controle aportes
// MAS_201903_HPC        : Se valida que se verifique aportes solo para tipo de asociado DO
// MAS_202001_HPC        : Se cambia CdsUpro por conflicto
//Inicio HPC_201801_MAS
// MAS_202309_HPC        : Solo para nivel 4, se obvia restricción al momento de generar
//                         cuenta de ahorros que no tenga aportes
...
begin
   ...
   // Inicio: MAS_201903_HPC
   // Se valida que se verifique aportes solo para tipo de asociado DO
   If Trim(DM1.cdsAso.fieldbyname('ASOTIPID').AsString) = 'DO' Then
   Begin
      // Inicio: MAS_201902_HPC
      // Se valida que no controle aportes
      If (Trim(DM1.cdsAso.fieldbyname('VALIDAAPORTE').AsString) = 'S') And (DM1.cdsAso.fieldbyname('ASOFRESNOM').AsString <> '01/03/2022') Then
      Begin
         ...
         If (Copy(DM1.CrgArea(DM1.wUsuario),6,2) < '03') Or
            ((Copy(DM1.CrgArea(DM1.wUsuario),6,2) =  '03') And (Trim(Copy(DM1.CrgArea(DM1.wUsuario),10,30)) <> 'JEFATURA')) Then
         }
...
var xSQL:String;
begin
//Inicio MAS_202001_HPC        : Se cambia CdsUpro por conflicto
   ...
   If DM1.cdsQry.RecordCount > 0 Then
       Result:=Copy(DM1.cdsQry.FieldByName('FECINI').AsString,7,4)+Copy(DM1.cdsQry.FieldByName('FECINI').AsString,4,2) ;
   DM1.cdsQry.Close;
//Fin MAS_202001_HPC
end;
...
//Inicio MAS_202001_HPC        : Se cambia CdsUpro por conflicto
   ...
   DM1.cdsQry.Close; DM1.cdsQry.DataRequest(xSQL); DM1.cdsQry.Open;
   If DM1.cdsQry.RecordCount > 0 Then
       Result:=DM1.cdsQry.FieldByName('FECCAL').AsString;
   DM1.cdsQry.Close;
//Fin MAS_202001_HPC
