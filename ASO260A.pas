...
// MAS_202309_HPC : Se modifica Qry, para solo mostrar los registros activos para su selección.
unit ASO260A;
...
var
  XSQL: string;
begin
  XSQL := 'SELECT CODOBS, DESOBS, RECOBS, USUARIO, FECHA FROM ASO_TIP_OBS_MAN WHERE NVL(ACTIVO,''N'') = ''S'' ORDER BY CODOBS';
  DM1.cdsQry8.Close;
  DM1.cdsQry8.DataRequest(XSQL);
  DM1.cdsQry8.Open;
