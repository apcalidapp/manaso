...
begin
   ...
   Begin
      ...
      DM1.cdsAso.FieldByname('ASOAPENOMDNI').AsString+' con C.E. '+
      DM1.cdsAso.FieldByname('ASODOCNUM').AsString+', actualmente labora en la Ugel '+
...
begin
  ...
  End;
   ...
   xSelect:=' asoid, asocodmod, asocodaux, asocodpago, asoapepat, asoapemat, asonombres, asoapenom, useid, uproid, upagoid,'
          ...
          +'latitud_dir, longitud_dir, D_COD_TUR, FECCADCAREXT ';
   ...
   xSQL:='SELECT ASOID FROM ASO_NUE_CLI WHERE SOLICITUD = '+QuotedStr(DM1.cdsAso.FieldByname('SOLICITUD').AsString)+' AND EST_AUT_CLI = ''N3''';
   DM1.cdsQry.Close;
   DM1.cdsQry.DataRequest(xSQL);
   DM1.cdsQry.Open;
   if DM1.cdsQry.RecordCount<=0 then
   ...
   xSQL:=' Insert into APO201( '
        ...
        +   'MDFFECMOD, EMICARTA, DESMANVIV, CODMOTDESTCUO, FECACTPAD, CENEDUID, D_COD_TUR, FECCADCAREXT) '
        +'Select '
        +   'ASOID, ASOCODMOD, ASOCODAUX, ASOCODPAGO, ASOAPEPAT, ASOAPEMAT, ASONOMBRES, '
        +   'ASOAPENOM, USEID, UPROID, UPAGOID, ASORESNOM, ASOFRESNOM, RESID, REGPENID, '
